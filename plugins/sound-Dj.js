...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/anshorfalahi',
    mediaType: 2, 
    description: 'www.instagram.com/anshorfalahi',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/ef6105e92cab05d1a5eb3.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/anshorfalahi'
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
