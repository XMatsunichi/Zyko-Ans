...
• *Kebijakan Privasi:*
1. AnshorXD tidak akan merekam data riwayat chat user.
2. AnshorXD tidak akan menyebarkan nomor users.
3. AnshorXD tidak akan menyimpan media yang dikirimkan oleh users.
4. AnshorXD tidak akan menyalah gunakan data data users.
5. Owner AnshorXD berhak melihat data riwayat chat users.
6. Owner AnshorXD berhak melihat status users.
7. Owner AnshorXD dapat melihat riwayat chat, dan media yang dikirimkan users.

• Jika ada bug/eror di website kami saya mohon untuk Report nya, tanpa biaya dan aman

_Cara penggunaan AnshorXD Agar terhindar dari Suspand_
...
• *Syarat Ketentuan AnshorXD:*

1. AnshorXD akan keluar dari group jika ada salah satu member melanggar peraturan.
2. AnshorXD dapat mem-ban users secara sepihak terlepas dari users salah atau tidak.
3. AnshorXD tidak akan bertanggungjawab atas apapun yang users lakukan terhadap fitur bot.
4. AnshorXD akan memberlakukan hukuman: block atau ban terhadap users yang melanggar peraturan.
5. AnshorXD bertanggung jawab atas kesalahan fatal dalam programing maupun owner.
❏┳━━◩
┍┛
┆⟥⟤ ➠ ${global.bottime}
└─┈⟅
